...
import 'package:theme_app/ui/widgets/app_bar.dart';
import 'package:theme_app/utils/constants.dart';
import 'package:theme_app/utils/theme.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ...
          // style: Theme.of(
          //   context,
          // ).textTheme.titleLarge?.copyWith(fontSize: largeTextSize),
        ),
      ),
      body: ListWidget(),
                ...
                child: ListTile(
                  trailing: Theme(
                    data: Theme.of(context).copyWith(
                      iconTheme: Theme.of(
                        context,
                      ).iconTheme.copyWith(color: Colors.grey),
                    ),
